...
public interface IF_EntityFunction {
	...
	Map<Entity, PathGridPosition> findPath(List<Entity> entities, short goalX, short goalY);
	
	Map<Entity, PathGridPosition> findPath(List<Entity> entities, Entity goalEntity);
