...
public class ItemRenderer implements IF_Renderer {
	...
	public void renderContainer(Container container, float worldX, float worldY) {
	...
	private void renderItems(E_Item item, int amount, float worldX, float worldY) {
		...
		for (int i = 0; i < amount; i++) {
			...
			spriteBatch.draw(itemTextureRegion, worldX + xOffset, -(worldY + yOffset) - Constant.HALF_TILE_SIZE, 0, 0, Constant.ITEM_WIDTH, Constant.ITEM_HEIGHT, 0.75f, 0.75f, rotation);
		}
	}
